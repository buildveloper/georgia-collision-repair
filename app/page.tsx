...
const makes = [
  ...
  "Hyundai", "Kia", "Subaru", "Ram", "GMC", "Dodge",
  "BMW", "Mercedes", "Other"
];
    ...
    <div>
      ...
      <div className="hero">
        <img
          src="/mainhero.png"
          loading="lazy"
          alt="Collision repair Georgia – Auto body shop near me in Atlanta GA"
        />
        ...
        <div className="hero-content">
          ...
          >
            Trusted auto body repair in Georgia. Get quotes from local shops in Atlanta, Savannah, Augusta for car collision repair near me, dent repair, and auto paint.<br />
            100% Free • No spam • Georgia only
          </p>
          ...
          <form action={handleSubmit} className="space-y-6">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Rear-ended, bumper damage, needs paint..."
              />
            </div>
            ...
            <div className="consent-label">
              ...
              <span>
                I consent to being contacted by phone, text, or email by local Georgia collision repair shops for repair quotes. This is a free service. I can opt out anytime.
              </span>
            </div>
